...
<?php $this->widget('bootstrap.widgets.TbNavbar',array(
    'items'=>array(
        array(
            ...
            'items'=>array(
                array('label'=>'Quản lý User', 'url'=>array('/user/admin') ),
                array('label'=>'Quản lý Menu', 'url'=>array('/menu/admin')),
                array('label'=>'Quản lý Ảnh Trình Diễn', 'url'=>array('/imageslide/admin')),
                array('label'=>'Quản lý Links', 'url'=>array('/link/admin')),
