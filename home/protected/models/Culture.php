 ...
 *
 * The followings are the available columns in table 'culture':
 * @property integer $id
...
{
  const image_url = '/uploadfile/culture/images/';
  const file_url = '/uploadfile/culture/file/';
  const video_url = '/uploadfile/culture/video/';
  /**
